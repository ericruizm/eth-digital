...
const Ajustar = (props) => (
  <div>
    ...
    <div
      onClick={() => { props.AbrirDatosUser(); }}
      className={props.ajustes.action === 'AbrirDatosUser' ? 'Boton_DatosUser_Marcado' : 'Boton_DatosUser_Desmarcado'}
    >
      <h3 className="Texto_Boton_DatosUser">Datos de usuario</h3>
    </div>
    <div
      onClick={() => { props.AbrirDatosPersonales(); }}
      className={props.ajustes.action === 'AbrirDatosPersonales' ? 'Boton_DatosPer_Marcado' : 'Boton_DatosPer_Desmarcado'}
    >
      <h3 className="Texto_Boton_DatosPer">Datos Personales</h3>
    </div>
    <div
      onClick={() => { props.AbrirContrasena(); }}
      className={props.ajustes.action === 'AbrirContrasena' ? 'Boton_Contrasena_Marcado' : 'Boton_Contrasena_Desmarcado'}
