    ...
    <div className="Wrapper_Tabla_Aportaciones">
      <div className="Titulo">
        <div className="Datos_Grid_Aportaciones">
          ...
          <div
            onClick={props.AbrirAlerta}
            className="Grid_Dias_Restantes"
          >
      ...
      <div className="Datos2">
        <div className="Datos_Grid_Aportaciones">
          ...
          <h3 className="Cantidad2">40 días</h3>
        </div>
      </div>
      <div className="Datos2">
        <div className="Datos_Grid_Aportaciones">
          ...
          <h3 className="Beneficio_Porcentaje">Aprobado</h3>
          <h3 className="ID_transaccion">ya18n8b1ljkbualmlonioYmTL</h3>
          <h3 className="Cantidad4">En saldo</h3>
        </div>
      </div>
